import { BorderRadiusObject, IStep, Steps, SVGMaskPathMorphParam, SvgPath, ValueXY, type KeyIterable } from './types';
...
export declare function shadowEqual<T extends KeyIterable>(o1: T | undefined, o2: T | undefined): boolean;
