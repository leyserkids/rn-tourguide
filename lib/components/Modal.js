...
export class Modal extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return (notShallowEqual(this.props, nextProps) ||
    ...
    async _animateMove(obj = {
        ...
        if (!((_a = this.props.currentStep) === null || _a === void 0 ? void 0 : _a.keepTooltipPosition)) {
    ...
    render() {
        ...
        return (React.createElement(RNModal, { animationType: "none", visible: containerVisible, onRequestClose: noop, transparent: true, supportedOrientations: ['portrait', 'landscape'] },
